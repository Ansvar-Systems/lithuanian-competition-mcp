...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across KT enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching decisions with case number, parties, outcome, fine amount, and GWB articles cited.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'piktnaudžiavimas dominuojančia padėtimi, kartelis')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific KT decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
        case_number: { type: "string", description: "Case number (e.g., '2023/11/03-3')" },
      },
  ...
  },
  {
    ...
    description:
      "Search KT merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'koncentracija, įsigijimas')" },
        sector: { type: "string", description: "Filter by sector ID. Optional." },
        outcome: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "List all sectors with KT enforcement activity, including decision and merger counts.",
      ...
      switch (name) {
        ...
        case "lt_comp_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "KT (German Federal Cartel Office) MCP server. Provides access to German competition law enforcement decisions, merger control cases, and sector enforcement data under the GWB (Gesetz gegen Wettbewerbsbeschränkungen).",
            data_source: "KT (https://www.bundeskartellamt.de/)",
